...
def instantiate_from_config(config):
    ...
    if 'basicsr.data' in config["target"] or 'FFHQ' in config["target"]:
...
class ImageLogger(Callback):
    def __init__(self, batch_frequency, max_images, clamp=True, increase_log_steps=True, max_val_batches=2):
        super().__init__()
    ...
    def log_img(self, pl_module, batch, batch_idx, split="train"):
        ...
        if split == "train":
            ...
            should_log = batch_idx < self.max_val_batches
...
if __name__ == "__main__":
    ...
    try:
        ...
        trainer_config["val_check_interval"] = 1.0
        ...
        default_modelckpt_cfg = {
            ...
            "params": {
                "dirpath": ckptdir,
                # "filename": "{epoch:06}",
                "filename": "{epoch:03}-{val_fid:.3f}-{val_niqe:.3f}-{val_BCE_loss:.3f}-{val_Rec_loss:.3f}",
                "monitor": "val_fid",
                "mode": "min", 
                "verbose": True,
                "save_last": True,
        ...
        default_callbacks_cfg = {
            "setup_callback": {
                "target": "main_GeoMAR.SetupCallback",
                "params": {
                    "resume": opt.resume,
                    "now": now,
                    "logdir": logdir,
            ...
            "image_logger": {
                "target": "main_GeoMAR.ImageLogger",
                "params": {
            ...
            "learning_rate_logger": {
                "target": "main_GeoMAR.LearningRateMonitor",
                "params": {
